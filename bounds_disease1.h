...
else if (i==11)	{	low = 0.5;			high = 1.50;	}		//sdr
else if (i==12)	{	low = 0.2;			high = 1.50;	}		//sdf

else if (i==13)	{	low = -1.0;			high = 1.00;	}		//gamma
...
else if (i==17)	{	low = .5;			high = 5.0;	}		//Covered_C
else if (i==18)	{	low = .066667;			high = 0.25;	}		//lambdaF

//else if (i==19)	{	low = -2.0;			high = -0.4;	}		//CK//
else if (i==19)	{	low = 440.0;			high = 520.0;	}		//CK// stop2 R_end.  time when resting spores stop blooming

else if (i==20)	{	low =1.0;			high = 8.50;	}		//CK// open_C
...
else if (i==21)	{	low = -3.20;			high = -2.20;	}		//CK// Rain scaling parameter func 2
//else if (i==21)	{	low = 0.0000001;			high = 0.2;	}		//CK// temp scaling parameter

else if (i==22)	{	low = -1.80;			high = -0.5;	}		//CK// RH scaling parameter

else if (i==23)	{	low = -1.50;			high = -0.450;	}		//CK// temp scaling parameter for muF
//else if (i==23)	{	low = 0.0001;			high = 0.2;	}		//CK// stop2 R_end.  time when resting spores stop blooming

else if (i==24)	{	low = 6.0;			high = 18.0;	}		//CK// open_c

else if (i==25)	{	low = 3.1;			high = 8.50;	}		//CK// open_R

else if (i==26)	{	low = -1.80;			high = -0.50;	}		//rain_P2

else if (i==27)	{	low = 70.0;			high = 120.0;	}		//CK// R_start.  time when resting spores start blooming
...
else if (i==28)	{	low = 220.0;			high = 310.0;	}		//CK// size_S. effect of size on susceptibility.

//else if (i==29)	{	low = -6.5;			high = -0.5;	}		//CK// size_C. effect of size on conidia production.
else if (i==26)	{	low = -2.50;			high = -0.50;	}		//rain_P2
...
else if (i==1)	{Slow = eps2;				Shigh = 10.1;					Rlow = -2.20;		Rhigh = -0.50;	}
else if (i==2)	{Slow = eps2;				Shigh = 10.1;					Rlow = -3.00;		Rhigh = -1.0;	}
else if (i==3)	{Slow = eps2;				Shigh = 10.1;					Rlow = -3.00;		Rhigh = -1.0;	}
else if (i==4)	{Slow = eps2;				Shigh = 10.1;					Rlow = -3.50;		Rhigh = -1.20;	}
else if (i==5)	{Slow = eps2;				Shigh = 10.1;					Rlow = -3.50;		Rhigh = -1.40;	}
else if (i==6)	{Slow = eps2;				Shigh = 10.1;					Rlow = -3.80;		Rhigh = -2.0;	}
...
for (i=1;i<=num_adj_pars;i++)	{
	if ((i==2||i==3||i==4||i==5||i==6||i==7||i==9||i==10||i==11||i==12||i==13||i==14||i==15||i==16||i==17||i==18||i==19||i==20||i==21||i==22||i==23||i==24||i==25||i==26||i==27||i==28||i==29) && (i!=pro))	{
		...
		else if (i==7||i==16||i==17||i==18||i==19||i==20||i==24||i==25||i==27||i==28)	{	//CK// Fungus params ONLY
		...
		//	Params->PARS[i] = 0.002;
		//}
		else if (i==2||i==4||i==5||i==8||i==10||i==11||i==15)	{	//CK// set virus parameters to 0. NO VIRUS
			Params->PARS[i] = 0.0;
		}
